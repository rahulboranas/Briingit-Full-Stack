...
console.log("file data uuu",file)
 if(!file){
    return
 }
 ...
 <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
    ...
    <div className='gap-1 grid'>
        ...
        <div className='flex flex-col lg:flex-row items-center gap-3'>
         ...
         <div className='px-4 py-1 rounded cursor-pointer border hover:bg-amber-400 hover:text-neutral-900  border-yellow-500 text-yellow-400 '> {loading==true ? "Loading..." : "Upload Image"}</div>
         <input type='file'
