    ...
    <section className='bg-blue-50 p-4 '>
      <div className='constainer mx-auto flex w-full gap-5 justify-between flex-col lg:flex-row p-4'>
        ...
        <div className='w-full bg-blue-50  '>
          <div className='flex justify-between mb-2 '>
            <h3 className='text-lg font-semibold '>Choose your address</h3>
            <button onClick={handleClose} className='bg-gray-100 rounded-full hover:bg-gray-300 hover:text-gray-950 p-1 mx-1'>
              <IoMdClose size={18}/>
            </button>
          </div>
          ...
          <div className='bg-white p-2 grid gap-4'>
            {
              addressList.map((address, index) => (
                <label
                  key={address + index + "_addresslist"}
            ...
            <div
              ...
              className='h-16 bg-blue-50 cursor-pointer border-2 border-gray-300 rounded border-dashed flex justify-center items-center'
            >
              Add address
            </div>
          </div>
          ...
          <div className='bg-white p-4'>
            ...
            <div className='flex w-full max-w-sm flex-col gap-2'>
              <button
                ...
                disabled={loading}
                className={`py-2 px-4 font-semibold rounded border-2 
                  ${loading
                    ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                    : "border-green-500 hover:bg-green-600 hover:text-white text-gray-700"
                  }`}
              >
